...
- Type while browsing to fuzzy-search artist, title, and video filenames.
- Use arrows to navigate, `Enter` to expand a track, and `Space` to add or remove its selected video from the queue.
